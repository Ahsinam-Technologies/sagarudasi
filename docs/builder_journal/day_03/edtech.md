...
3. **Outcome type (What?)**: Learning, Career, Operational, Discovery **(4 possibilities)**. 
...
| --- | --- | --- | --- | --- | --- | --- | 
| <ul><li>JEE</li><li>BITSAT</li><li>VITEE</li><li>SRMJEE</li><li>MET</li><li>MHCET</li><li>KCET</li><li>WBJEE</li><li>KEAM</li><li>EAMCET</li></ul>| NEET | <ul><li>CUET UG</li><li>IISER Aptitude Test (IAT)</li><li>NEST</li><li>ISI Admission Test</li><li>CMI Entrance Exam</li></ul> | <ul><li>CUET UG</li><li>IPMAT</li><li>NPAT</li><li>SET</li><li>Christ Uni Entrance Test</li><li>St Xavier's EE</li><li>Ashoka Aptitude Test</li></ul> | <ul><li>CLAT</li><li>AILET</li><li>SLAT</li><li>LSAT</li></ul> | <ul><li>UCEED</li><li>NID DAT</li><li>NIFT EE</li></ul> | <ul><li>NATA</li><li>JEE BArch Paper 2</li></ul> |

Any platform created for UG competitive exams, can also deliver PG competitive exams. 

| MBA | Engineering | Science | PhD | Law | Commerce | Study Abroad | 
| --- | --- | --- | --- | --- | --- | --- |
| <ul><li>CAT</li><li>XAT</li><li>NMAT</li><li>SNAP</li><li>CMAT</li></ul> | <ul><li>GATE</li><li>PG CET</li></ul> | <ul><li>CUET PG</li><li>JAM</li><li>TIFR GS</li><li>JEST</li><li>NBHM</li><li>ISI Admission Test</li><li>CMI Entrance Exam</li></ul> | <ul><li>UGC NET</li><li>CSIR NET</li><li>ICMR JRF</li><li>DBT JRF</li></ul> | <ul><li>CLAT PG</li><li>AILET PG</li></ul> | <ul><li>CUET PG</li><li>MAH CET</li><li>CP GET</li><li>IPU CET</li><li>BHU PET</li><li>PU CET</li><li>Christ Entrance Test</li></ul> | <ul><li>GRE</li><li>GMAT</li><li>TOEFL</li><li>IELTS</li></ul> | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | 
| <ul><li>UPSC</li><li>PSC: UP PSC, MP PSC, BPSC, RPSC, etc.</li><li>CAPF</li></ul> | <ul><li>SBI PO</li><li>IBPS PO</li><li>RBI Grade B</li><li>NABARD, SEBI, SIDBI</li><li>LIC AAO/ADO</li></ul> | <ul><li>CDS: IMA, OTA, INA, AFA</li><li>AFCAT</li><li>NDA</li></ul> | <ul><li>GATE</li><li>ESE</li><li>ISRO, DRDO, BARC</li></ul> | <ul><li>Judicial Services Exam</li><li>Public Prosecutor Exams</li><li>Law Officer Exams</li></ul> | <ul><li>ICAI: CA</li><li>ICSI: CS</li><li>ICMAI: CMA</li><li>CFA</li></ul> | <ul><li>UGC NET</li><li>CSIR NET</li><li>State TET</li></ul> | <ul><li>Labour Office</li><li>Food Safety Officer</li><li>Drug Inspector</li><li>Customs & Excise</li><li>Intelligence Bureau (ACIO)</li></ul> |
...
1. **Social Proof & Network Effects.** Which other parents like me are sending their kids here? Alumni parents matter more than Google reviews. WhatsApp groups, apartment communities, office referrals dominate.
2. **Ease of Access (non-negotiable constraint).** Distance: $\le$ 15 minutes walking or $\le$ 10 minutes driving. On the daily commute path (home $\rightarrow$ office). Flexible drop/pick timings ($\pm$ 30 minutes buffer). If it adds friction to weekday mornings, it’s rejected regardless of pedagogy.
3. **Safety & Trust Signals.** CCTV, Hygiene routines, Staff continuity, Escalation clarity (Who do I call if something goes wrong?), etc., everything matters. 
4. **Learning Pedagogy.** This is secondary, but is now becoming a differentiating factor. Language exposure, Play-based structure, Social skills, routines, discipline, etc., all of these matter. Parents don’t evaluate pedagogy deeply, but they compare narratives. 
...
**What we can't prove?** Long-term academic success and IQ gains.
**What we should prove?** Safety consistency, Routine adherence, Parent NPS, Teacher stability, Child engagement (observable). 
...
1. **Catch Up**: Designed for kids in Tier 2+ cities. Or those from a lower income strata or who are first generation English learners. Oftendesigned as English learning apps, to help the child learn the basics of English before she starts formal schooling in order to *catch up* to the rest of the students. 
2. **Premium**: Designed for kids in Tier 1 cities / urban areas or those from a higher income strata or with educated parents. These services are tailored to help the child learn new words, strengthen concepts like numbers, objects, animals, etc. They engage the child to improve brain development and make the transition to formal schooling smoother. 
...
1. **Aspirational Anxiety (Primary Driver)**: Parents don’t buy because they believe in neuroscience or pedagogy. They buy because other kids seem ahead, English exposure is perceived as irreversible advantage, and school admissions feel competitive earlier each year. 
2. **Social Proof > Proof of Learning**: Which app are kids in my apartment using? Is the app being discussed in Whatsapp groups? It's majorly driven by social proof. Measurable outcomes matter less than percieved momentum. 
3. **Parent Effort Threshold**: Products fail when parents have to involve actively rather than facilitating and demands their time > 15 minutes. Also, the setup shouldn't feel cognitively heavy. Parents need outsourced progress, not another job. 
4. **Price Sensitivity**: (a) Catch-up market: highly price-sensitive, churns fast, compares against free YouTube. (b) Premium market: less price-sensitive but extremely comparison-heavy. Will only pay 500-1,000 INR a month if the delight is immediate. 
...
1. **Gamification of EdTech**: AR/VR, animation, characters, two-way interaction are becoming table stakes.
2. **English as Social Capital**: First-generation learners’ parents increasingly outsource English exposure to apps.
3. **Non-academic/Behavioural learning:** EQ, confidence, empathy are gaining legitimacy as *skills*.
4. **Global-first GTMs**: Markets like UK (7+ exam obsession) offer clearer willingness to pay. India can be positioned as a derivative expansion, not the core.

**Why build this?**

1. Nascent market in India but evolved market in the US - a lot of scope exists to experiment with the product, payments, pricing, medium, and help define the market. 
2. The last 3-5 years have seen tremendous technological innovation in this subsector, making it a very exciting time to be building products in this space

**Why this is hard?**

1. Small TAM in India. Companies are still to prove the existence of market beyond India 1A. 
2.  Hard for parents to measure outcomes (unlike in K12 where marks are a proxy, or test prep where college admissions / job offers are a proxy) - making it hard to convince some parents to buy, or increase LTV of existing users. 
3. Weak moats and churn is structural. 
...
[^1]: [It Is Edtech's Moment: Dissecting the Indian Edtech Sector](https://aspirecircle.org/wp-content/uploads/2020/08/Blume-Ventures-Edtech-report_opt.pdf) by Blume VC, Summer 2020.
[^2]: [EdTech Landscape In India: What Changed In The Post Pandemic Years](https://blume.vc/reports/edtech-landscape-in-india-what-changed-in-the-post-pandemic-years) by Blume VC, December 2022. 
[^3]: [EdTech Bluprint - Winter 2024](https://blume.vc/reports/edtech-bluprint-winter-2024) by Blume VC, December 2024.