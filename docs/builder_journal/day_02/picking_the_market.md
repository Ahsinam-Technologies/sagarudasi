...
!!! note "The Markets They Ended Up Picking!"
    ...
    * Om & Julias wanted to revolutionize the entire education industry by creating a platform that enables the learner to learn in their own preferred style, based on the **VARK framework** (Visual, Auditory, Reading, Kinesthetic). From the market perspective, the idea falls in the **education** space. It's a giagantic market with reports citing sizes upto $10 trillion globally by 2030. Also, I happen to have a personal bias towards education. However, their idea is still very raw and half-baked. There are a lot of improvements that are required: from drafting the problem statement to finding the wedge. Also, I am personally not a big fan of VARK theory, as it is not accurate. Refer to this video by Derek (Veriasium), [The Biggest Myth In Education](https://www.youtube.com/watch?v=rhgwIhB58PA)[^1].   

    * Suhani had 3 ideas! The first one being a sticker that you can attach on your valuables. If the items are taken away beyond a distance relative to your mobile phone, your phone will ring notifications. While she proposed this as a way to not lose items personally, I looked at this idea as a security tag for malls, supermarkets, jewellery shops, etc. However, this gets into the electronics and nitty-gritty details like battery life, would stickers need recharge, etc. It was a no because such ideas aren't conducive in India and building a hardware prototype in the timeline at hand is not possible. The second idea was to build a wrist band and ankle band, that monitors your form while you are gyming, playing sports, or exercising. If you get a injury, the bands will suggest the best plan of action (maybe a remedy or injury management ways). It had a great potential if instead of advisory, it does the analytics first and provide the best way to improve the form for atheletes. But again, hardware involvement made it tricky! Finally, the third one was to evaluate employees based on their behaviour and bring the culture-fit angle to the recruitment, and not just skill-fit angle. This is the **recruitment/HRTech** space. We had no clue how we will do, what exactly we will do, or any kind of details. I was pretty sure the entire idea will get revamped. But I stuck with this because,the market was massive! Reports say HRTech is $600 billion globally. 

    * Isaiah wanted to make small LLMs local and make it deployable in every company, so that they can securely leverage the AI power without needing to send the sensitive data to OpenAI. Secondly, he also wanted to visualize the chatflows (to maybe eventually create something like mindmaps). I was a bit skeptical of the idea because I wasn't sure how is this different from RAG outcome-wise. Now, Isaiah is from the US. US has massive pools of high risk capital. Deep Tech companies usually rely on funding for years, sometimes even a decade, and then eventually they hope economies-of-scale to work in action and become profitable. However, that deeptech playbook won't work when the goal is to generate revenue in 4 months. So, with a heavy heart, despite **Deep Tech** being my one of the favourite spaces which is massive as well, we had to drop this idea. 

    * Diego wanted to make a social media app, which eventually got modified to a dating app. Such ideas are classic **tarpit ideas**. Refer to this video by YC, [Tarpit Ideas](https://www.youtube.com/watch?v=GU9iT7MW0rs)[^2]. Very common to get such ideas, very unlikely that they would make money without dark patterns. 

    * Sandra wanted to make a AI Voice Tech, where we make the AI voice more human. There are many applications of this technology: in real estate, hospitals, colleges, banks, insurance, etc. It's a huge market. But the current state-of-the-art models are also not good enough and are expensive if they are, making them not business feasible. To be able to pull off this project, requires great deal of technical expertise, full time research oriented mindset, and a market willing to bear high cost pilots. **Voice Tech** is a great space, just not feasible again. 

    * Diego and Sandra, both dropped their ideas, to become a team and they picked **education**, an evergreen space in India. Isaiah was merged with Suhani and will take his inputs, on if recruitment is the space, what would he love to make in it!

    | | Members | Final Markets Picked | 
    | --- | --- | --- | 
    | Team 1 | **Om Denkar** & **Julian Rojas** | Education |
    | Team 2 | **Suhani Makkar** & **Isaiah Fosnight** | Recruitment |
