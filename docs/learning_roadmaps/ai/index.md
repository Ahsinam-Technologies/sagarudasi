...
=== "**Bachelor's Program**"
    ...
    **Program's  Goal:** Building AI Engineers, Research Engineers, and Technical Founders in AI/ML Infrastructure.
    ...
    This program is **not designed to produce employees;** it is designed **to produce AI engineers who can build, scale, and deploy intelligent systems**. The curriculum assumes that modern AI systems require deep understanding of: **math $\rightarrow$ computation $\rightarrow$ parallelism $\rightarrow$ optimization $\rightarrow$ intelligence $\rightarrow$ systems $\rightarrow$ users.**
    ...
    **TERM 1: Foundations + First Ship**
    ...
    | CS 103 | Fundamentals of Web Development | The course wants you to ship your code as early as week one! You'll learn faster when you'll actually build things. Even AI models need interfaces. |
    ...
    **TERM 5: Distributed Systems**
    ...
    | CS 307 | Introduction to Parallel Computing | Modern AI runs on GPUs and distributed systems. Learn parallel algorithms, threading, SIMD, GPU basics. Understand why matrix multiplication is fast and why some operations aren't parallelizable. | 
    ...
    **TERM 6: Data & Security**
    ...
    | CS 308 | GPU Programming & CUDA | Write kernels, understand memory hierarchies, optimize throughput. Learn to think in warps and blocks. Essential for understanding how modern AI training actually runs. | 
    ...
    | CS 309 | High Performance Computing Systems | Distributed memory systems, MPI, cluster computing, InfiniBand. How to train models across hundreds of GPUs. Performance profiling and optimization at scale. | 
...
=== "**Master's Program**" 
    ...
    **Program's Goal:** Building Technical Builders with **specialized knowledge** in at least one area of computing. 
    ...
    === "Network Intelligence & Social Systems"
...
=== "**Certification Program**"
    ...
    **TERM 1: Foundational Skills**
    ...
    > **Note:** Students should be able to hunt basic tech jobs with this much skillset alone. However, it is recommended to finish Term 2 as well, especially for the AI course. 

    **TERM 2: Core Machine Learning & AI Skills**
    ...
    > **Note:** Ideally, students should be able to crack MLE 1 or Senior MLE roles after both terms, depending on their experience.  